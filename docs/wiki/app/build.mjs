...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "concepts/05-source-of-truth-flip.md", idx: "5", title: "The Source-of-Truth Flip", title_zh: "真相源翻转" },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "mechanisms/07-unsafe-lane.md", idx: "7", title: "The Unsafe Lane", title_zh: "Unsafe Lane" },
    ],
  },
  {
    title: "Guides",
