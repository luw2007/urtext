...
## C008 Domain clustering inventories every observed code, test, and contract file <!-- oracle:test:tests/distill.test.ts risk:high refs:specs/distill/spec.md#C001 -->
